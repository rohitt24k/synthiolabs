...
const VideoCallFrame = () => {
  return (
    <>
      ...
      {/* Action buttons */}
      <div className=" absolute bottom-4 flex justify-center -mt-9 items-center gap-6 bg-[#F8F8F8]/50I backdrop-blur-[20px] rounded-full px-4 py-2 shadow-[0_0_0_2px_rgba(0,0,0,0.04),inset_0_0_12px_rgba(214,220,231,0.24)]">
